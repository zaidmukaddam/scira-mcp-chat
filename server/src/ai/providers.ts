...
// import { createGroq } from "@ai-sdk/groq"; // Not installed
import { createAnthropic } from "@ai-sdk/anthropic";
// import { createXai } from "@ai-sdk/xai"; // Not installed
...
// const groqClient = createGroq({ // Not installed
//   apiKey: getApiKey('GROQ_API_KEY'),
// });

// const xaiClient = createXai({ // Not installed
...
const languageModels = {
  ...
  // "qwen-qwq": wrapLanguageModel( // Groq not installed
  //   {
  //     model: groqClient("qwen-qwq-32b"),
  //     middleware
  //   }
  // ),
  // "grok-3-mini": xaiClient("grok-3-mini-latest"), // XAI not installed
};

export const modelDetails: Record<string, ModelInfo> = { // Adjusted type for flexibility
  "gpt-4.1-mini": {
    provider: "OpenAI",
    name: "GPT-4.1 Mini",
...
export type modelID = keyof typeof languageModels; // This will now correctly reflect available models

export const MODELS = Object.keys(languageModels);

export const defaultModel: modelID = "gpt-4.1-mini"; // Adjusted default model
