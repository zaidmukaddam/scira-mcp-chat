...
import { ChevronDownIcon, ChevronUpIcon, LightbulbIcon, BrainIcon, MaximizeIcon, MinimizeIcon } from "lucide-react";
...
const TextPart = memo(({ text, role }: { text: string; role: TMessage["role"] }) => {
  return (
    <div
